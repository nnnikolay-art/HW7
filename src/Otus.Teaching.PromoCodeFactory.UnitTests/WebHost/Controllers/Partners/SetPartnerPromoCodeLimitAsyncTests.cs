...
namespace Otus.Teaching.PromoCodeFactory.UnitTests.WebHost.Controllers.Partners
{
    public class SetPartnerPromoCodeLimitAsyncTests
    {
        ...
        public SetPartnerPromoCodeLimitAsyncTests()
        {
            ...
            _parentPromocodeLimit = fixture.Build<SetPartnerPromoCodeLimitRequest>().With(p => p.EndDate, DateTime.Now.AddDays(2)).With(p => p.Limit, 28).Create();
        }
            ...
            var partner = new Partner()
            {
                ...
                PartnerLimits = new List<PartnerPromoCodeLimit>()
                {
                    new PartnerPromoCodeLimit()
                    {
                        ...
                        CreateDate = new DateTime(2024, 07, 9),
        ...
        {
            // Arrange
            var partnerId = Guid.Parse("def47943-7aaf-44a1-ae21-05aa4948b170");
